...
class GradeCalculator{
	...
	static double lowestLab(){
		...
		while (i <= labTotalNumber){
			if (i == 1){
				System.out.println("Please enter your " + i + "st lab grade out of 50.");
			}
			else if (i == 2){
				System.out.println("Please enter your " + i + "nd lab grade out of 50.");
			}
			else if (i == 3){
				System.out.println("Please enter your " + i + "rd lab grade out of 50.");
			}
			else{
				System.out.println("Please enter your " + i + "th lab grade out of 50.");
			}
